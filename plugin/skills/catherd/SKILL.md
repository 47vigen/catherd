...
4. For a worker:
   ...
   - "Run the full suite only if this brief says so", and "Wrap any full build or full test suite in `bunx catherd-cli lock -- <command>`": other lanes share the machine.
